#!/usr/bin/env python3
"""
Clean CLIP fine-tuning script for HAR dataset
"""
...
class CLIPTrainer:
    ...
    def setup_data(self):
        ...
        # Try to create validation dataset, fall back to test if no val
        try:
            ...
            try:
                ...
                logger.info("Using test split for validation (no val split found)")
            except ValueError:
                ...
                logger.info("Created train/val split from training data")
